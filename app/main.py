...
#     individual_probs = model.predict_proba(input_array_scaled)

#     # Print the individual model probabilities to the terminal
#     print("Individual model probabilities:")
#     for i, prob in enumerate(individual_probs[0]):
#         print(f"Model {i + 1} - Benign Probability: {prob[0]:.4f} | Malignant Probability: {prob[1]:.4f}")
